...
public partial class WheelUI : VBoxContainer
{
    ...
    public override void _Draw() {
		...
		var dir = new Vector2(Wheel.GripDir.X, Wheel.GripDir.Z) / new Vector2((float)Wheel.Car.Details.TractionDetails.LatGripMax, (float)Wheel.Car.Details.TractionDetails.LongGripMax);
