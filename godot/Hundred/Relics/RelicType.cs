...
public record RelicType(string Name) {
    ...
    public static readonly RelicType COLLISIONDAMAGEREDUCE = typeof(CollisionDamageReductionRelic).Name;
    public static readonly RelicType MONEYINRIVALRACE = typeof(MoneyInRivalRaceRelic).Name;
