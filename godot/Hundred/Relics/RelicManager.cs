...
public partial class RelicManager : Node {
    ...
    public Relic GenerateRelic(RelicType type, float strength = 1) {
        ...
        // https://stackoverflow.com/questions/22698701/get-constructor-matching-parameters
        ...
        } else if (type == RelicType.COLLISIONDAMAGEREDUCE) {
            return new CollisionDamageReductionRelic(this, strength);
        }
